...
CREATE TABLE `calibracao` (
  `cal_cod` int(11) NOT NULL,
  `cal_datacalibracao` date DEFAULT NULL,
  `cal_certificado` varchar(100) DEFAULT NULL,
  `cal_periodicidade` int(11) DEFAULT NULL,
  `cal_laudofinal` varchar(244) DEFAULT NULL,
  PRIMARY KEY (`cal_cod`)
